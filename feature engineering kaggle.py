...
### Below is the same thing but with no interaction / non-linear terms (good for tree models)
...
drop_columns = ['Name', 'Ticket', 'Cabin', 'Sex', 'Embarked', 'Title', 'FamilyID']
combined_df.drop(drop_columns, axis=1, inplace=True)
...
train_df.to_csv('/Users/scott/Downloads/titanic/train_engineered_no_interaction.csv', index=False)
test_df.to_csv('/Users/scott/Downloads/titanic/test_engineered_no_interaction.csv', index=False)
